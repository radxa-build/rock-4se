# ROCK 4SE
[![Build image for Release channel](https://github.com/radxa-build/rock-4se/actions/workflows/build.yaml/badge.svg)](https://github.com/radxa-build/rock-4se/actions/workflows/build.yaml) [![Build image for Test channel](https://github.com/radxa-build/rock-4se/actions/workflows/test.yaml/badge.svg)](https://github.com/radxa-build/rock-4se/actions/workflows/test.yaml)
...
Please also always use [the latest release](https://github.com/radxa-build/rock-4se/releases/latest) instead of any pre-release / test builds. Those will not be supported.
